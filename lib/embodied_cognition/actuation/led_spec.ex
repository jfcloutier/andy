defmodule Andy.LEDSpec do
  ...
  def matches?(%Andy.LEDSpec{} = led_spec, device) do
    device.class == :led and device.props.position == led_spec.position and
      device.props.color == led_spec.color
  end
end
