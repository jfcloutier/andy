      ...
      ActuatorConfig.new(
        ...
        specs: [
          %SoundSpec{
            name: :loud_speech,
            type: :speech,
            props: %{volume: :loud, speed: :normal, voice: get_voice()}
          }
        ],
        activations: [
          %Activation{intent: :say_calm_down, script: say_calm_down()},
          %Activation{intent: :say_share_food, script: say_share_food()},
          %Activation{intent: :say_parenting, script: say_parenting()}
        ]
      ),
      ActuatorConfig.new(
        name: :communicators,
        ...
        activations: [
          %Activation{
            intent: :command,
            # intent value = %{command: command, to_url: url}
            script: command()
          }
        ]
      )
