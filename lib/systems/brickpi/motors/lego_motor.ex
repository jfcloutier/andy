defmodule Andy.BrickPi.LegoMotor do
  ...
  # {value, updated_motor} - value can be nil
  ...
  def get_sys_controls(motor) do
    %{
      ...
      # in counts/sec,
      speed: get_attribute(motor, "speed_sp", :integer),
      ...
      # in counts,
      position: get_attribute(motor, "position_sp", :integer),
