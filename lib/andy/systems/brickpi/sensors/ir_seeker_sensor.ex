defmodule Andy.BrickPi.IRSeekerSensor do
  ...
  defp do_read(sensor, sense) do
    ...
    cond do
      ...
      sense in [:proximity, :proximity_mod] ->
        if dir_value == 0 do
          ...
          signal_strength =
            if dir_value in [1, 3, 5, 7, 9] do
              ...
              Logger.debug("IR_SEEKER: getting attribute value#{index} for dir_value = #{dir_value}")
              ...
              Logger.debug("IR_SEEKER: getting attribute value#{index + 1} for dir_value = #{dir_value}")
